...
//                             NotSupport[GetKey(g2, j)].Add(new[] { g, new Group {GroupNum = i} });
//                             NotSupport[GetKey(g, i)].Add(new[] { g2, new Group {GroupNum = j} });
//                         }
//                     }
//                 }
//             }
//             // return new Task<bool>(Search(groups, 1));
...
//                 if (pair[0].Periods[pair[1].GroupNum].RemovedAtLevel != 0 ||
